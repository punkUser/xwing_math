...
public class SimulationSetup2
{
    public struct Attack
    {
        ...
        // TODO: Might have to separate must vs. may in the future; for now always do them
        int hit_to_crit_count = 0;

        // TODO: May want to split out ruthless later as it's not exactly free
...
public SimulationSetup2 to_simulation_setup2(ref const(AttackForm) attack, ref const(DefenseForm) defense)
{
    SimulationSetup2 setup = new SimulationSetup2;
...
// the first place.
public SimulationSetup2 to_simulation_setup2(ref const(AttackForm) attack)
{
...
public SimulationSetup2 to_simulation_setup2(ref const(DefenseForm) defense)
{
